            ...
            <div className="bg-indigo-50">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6 ">
                        ...
                        <button onClick={handleGoogleSignIn} aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
                ...
                <div className="pl-8 md:block hidden">
                        <div className="text-center lg:text-left pt-8 pl-5">
                <img className='w-3/4' src='https://img.freepik.com/free-vector/account-concept-illustration_114360-399.jpg?w=740&t=st=1667977903~exp=1667978503~hmac=2d23a2c5150ab1e674f52eec887b3d2c55737f534c3f1827a489f2d2703d2e24' alt="" />
                </div>
                </div>
                </div>
                </div>
